...
func (*QANData) Descriptor() ([]byte, []int) {
	return fileDescriptor_qan_9a0ed76a7fd99353, []int{0}
}
...
func (*QANData_Row) Descriptor() ([]byte, []int) {
	return fileDescriptor_qan_9a0ed76a7fd99353, []int{0, 0}
}
...
func init() { proto.RegisterFile("agent/qan.proto", fileDescriptor_qan_9a0ed76a7fd99353) }

var fileDescriptor_qan_9a0ed76a7fd99353 = []byte{
