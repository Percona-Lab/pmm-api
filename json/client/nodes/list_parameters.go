...
type ListParams struct {
	...
	/*Body*/
	Body models.InventoryNodesListRequest
...
func (o *ListParams) WithBody(body models.InventoryNodesListRequest) *ListParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the list params
func (o *ListParams) SetBody(body models.InventoryNodesListRequest) {
	o.Body = body
}
