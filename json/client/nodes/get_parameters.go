...
type GetParams struct {
	...
	/*Body*/
	Body *models.InventoryNodesGetRequest
...
func (o *GetParams) WithBody(body *models.InventoryNodesGetRequest) *GetParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get params
func (o *GetParams) SetBody(body *models.InventoryNodesGetRequest) {
	o.Body = body
}
